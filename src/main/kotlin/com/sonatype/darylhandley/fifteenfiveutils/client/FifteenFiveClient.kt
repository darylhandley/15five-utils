...
interface FifteenFiveClient {
    ...
    @Headers("Cookie: sessionid={sessionId}")
    fun getObjectives(@Param("page") page: Int, @Param("pageSize") pageSize: Int, @Param("sessionId") sessionId: String): ObjectivesResponse
    
    @RequestLine("GET /objectives/api/objectives/?page={page}&page_size={pageSize}&state=current&user={userId}")
    @Headers("Cookie: sessionid={sessionId}")
    fun getObjectivesByUser(@Param("page") page: Int, @Param("pageSize") pageSize: Int, @Param("userId") userId: Int, @Param("sessionId") sessionId: String): ObjectivesResponse
